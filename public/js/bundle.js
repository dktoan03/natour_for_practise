...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */ // import axios from 'axios'
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Update successful"));
          }
          console.log(res);
          _context.next = 12;
          break;
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51P6HM5KRI5zKbpaz9irXT7cw3f3y2i6SQSRpQvsxmPr10rxhHOHuyXAvSgcCqC4vqPNK3o5HJMUdYxXFajuDqvZm00bNgzXZPj');
          _context.prev = 1;
          _context.next = 4;
          return axios("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId));
        case 4:
...
if (updateBtn) updateBtn.addEventListener('submit', function (e) {
  e.preventDefault();
